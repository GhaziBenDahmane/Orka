...
export type Cluster = { id: string; name: string; slug: string; state: string; labels: Record<string, unknown>; capacity: Record<string, unknown>; agentVersion: string; agentImage: string; agentUpdateState: string; dockerVersion: string; certificateNotAfter?: string; lastSeenAt?: string; maintenanceStartsAt?: string; maintenanceEndsAt?: string };
...
export type SAMLProvider = { id: string; name: string; domains: string[]; emailAttribute: string; nameAttribute: string; defaultRole: string; allowIdpInitiated: boolean; enabled: boolean; spCertificateNotAfter?: string; idpCertificateNotAfter?: string; certificateConfigurationOk: boolean };

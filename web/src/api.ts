...
export type Database = { id: string; environmentId: string; composeServiceId: string; name: string; slug: string; engine: string; version: string; driverSource: "built-in" | "external" | "unbound"; driverArtifactDigest?: string; managementKind: "managed" | "compose"; connectionServiceName?: string; storageNodeId?: string; status: string };

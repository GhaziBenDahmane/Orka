...
export type Service = { id: string; environmentId: string; name: string; slug: string; stackName?: string; storageNodeId?: string; revision: number; status: string; composeYaml?: string };

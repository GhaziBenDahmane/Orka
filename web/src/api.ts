...
export type ApplicationSource = { composeServiceId: string; repositoryUrl: string; gitRef: string; contextDirectory: string; dockerfile: string; buildType: "dockerfile" | "static"; outputDirectory?: string; buildTarget?: string; enableSubmodules: boolean; hasBuildArguments: boolean; hasBuildSecrets: boolean; targetService: string; registryImage: string; gitCredentialId?: string; registryCredentialId?: string; statusProvider?: string; statusCredentialId?: string; statusContext?: string; updatedAt: string };
...
export const api = {
  ...
  upsertSource: (serviceId: string, body: { repositoryUrl: string; gitRef: string; contextDirectory: string; dockerfile: string; buildType: "dockerfile" | "static"; outputDirectory?: string; buildTarget?: string; enableSubmodules: boolean; buildArguments?: Record<string, string>; buildSecrets?: Record<string, string>; targetService: string; registryImage: string; gitCredentialId?: string; registryCredentialId?: string; statusProvider?: string; statusCredentialId?: string; statusContext?: string }) => request<ApplicationSource>(`/v1/services/${serviceId}/source`, { method: "PUT", body: JSON.stringify(body) }),

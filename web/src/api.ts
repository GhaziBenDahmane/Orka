...
export type DatabaseBackup = { id: string; databaseInstanceId: string; status: string; format: string; sizeBytes?: number; sha256?: string; encrypted: boolean; destinationId?: string; utilityImage?: string; error?: string; createdAt: string; startedAt?: string; finishedAt?: string };

...
export type TemplateRepository = { id: string; name: string; slug: string; repositoryUrl: string; gitRef: string; catalogPath: string; enabled: boolean; lastSyncStatus: string; lastSyncError?: string; lastSyncedAt?: string };
...
export const api = {
  ...
  createTemplateRepository: (body: { name: string; slug: string; repositoryUrl: string; gitRef: string; catalogPath: string }) => request<TemplateRepository>("/v1/template-repositories", { method: "POST", body: JSON.stringify(body) }),

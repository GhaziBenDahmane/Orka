...
| SSO and SCIM | provider configuration, SP keys, SCIM token hashes | discovery documents, assertions, claims, directory writes | exact issuer/audience/domain checks, PKCE/nonce/state, XML signatures, replay protection, tenant binding |

...
func TestCommandRequestMappings(t *testing.T) {
	tests := []struct {
		...
		{[]string{"service", "service-id"}, http.MethodGet, "/v1/services/service-id"},
		{[]string{"service-variables", "service-id"}, http.MethodGet, "/v1/services/service-id/variables"},
		{[]string{"set-service-variables", "service-id", `{}`}, http.MethodPut, "/v1/services/service-id/variables"},
		{[]string{"delete-service-variable", "service-id", "API_KEY"}, http.MethodDelete, "/v1/services/service-id/variables/API_KEY"},
		{[]string{"route", "route-id"}, http.MethodGet, "/v1/routes/route-id"},
		{[]string{"create-route", "service-id", `{}`}, http.MethodPost, "/v1/services/service-id/routes"},
		{[]string{"update-route", "route-id", `{}`}, http.MethodPut, "/v1/routes/route-id"},
		{[]string{"delete-route", "route-id"}, http.MethodDelete, "/v1/routes/route-id"},
		{[]string{"route-basic-auth-users", "service-id"}, http.MethodGet, "/v1/services/service-id/basic-auth-users"},
		{[]string{"create-route-basic-auth-user", "service-id", `{}`}, http.MethodPost, "/v1/services/service-id/basic-auth-users"},
		{[]string{"update-route-basic-auth-user", "service-id", "user-id", `{}`}, http.MethodPut, "/v1/services/service-id/basic-auth-users/user-id"},
		{[]string{"delete-route-basic-auth-user", "service-id", "user-id"}, http.MethodDelete, "/v1/services/service-id/basic-auth-users/user-id"},
		...
		{[]string{"schedules", "service-id"}, http.MethodGet, "/v1/services/service-id/schedules"},
		{[]string{"schedule", "service-id", "schedule-id"}, http.MethodGet, "/v1/services/service-id/schedules/schedule-id"},
		{[]string{"create-schedule", "service-id", `{}`}, http.MethodPost, "/v1/services/service-id/schedules"},
		{[]string{"update-schedule", "service-id", "schedule-id", `{}`}, http.MethodPut, "/v1/services/service-id/schedules/schedule-id"},
		{[]string{"delete-schedule", "service-id", "schedule-id"}, http.MethodDelete, "/v1/services/service-id/schedules/schedule-id"},
		{[]string{"run-schedule", "service-id", "schedule-id"}, http.MethodPost, "/v1/services/service-id/schedules/schedule-id/executions"},
		{[]string{"schedule-executions", "service-id"}, http.MethodGet, "/v1/services/service-id/schedule-executions"},
		{[]string{"cancel-schedule-execution", "service-id", "execution-id"}, http.MethodPost, "/v1/services/service-id/schedule-executions/execution-id/cancel"},
		{[]string{"database-engines"}, http.MethodGet, "/v1/database-engines"},
		{[]string{"source-credentials"}, http.MethodGet, "/v1/source-credentials"},
		{[]string{"create-source-credential", `{}`}, http.MethodPost, "/v1/source-credentials"},
		{[]string{"rotate-source-credential", "credential-id", `{}`}, http.MethodPut, "/v1/source-credentials/credential-id"},
		{[]string{"delete-source-credential", "credential-id"}, http.MethodDelete, "/v1/source-credentials/credential-id"},
		{[]string{"custom-tls-certificates"}, http.MethodGet, "/v1/custom-tls-certificates"},
		{[]string{"create-custom-tls-certificate", `{}`}, http.MethodPost, "/v1/custom-tls-certificates"},
		{[]string{"update-custom-tls-certificate", "certificate-id", `{}`}, http.MethodPut, "/v1/custom-tls-certificates/certificate-id"},
		{[]string{"delete-custom-tls-certificate", "certificate-id"}, http.MethodDelete, "/v1/custom-tls-certificates/certificate-id"},
		...
		{[]string{"tags"}, http.MethodGet, "/v1/tags"},
		{[]string{"tag", "tag-id"}, http.MethodGet, "/v1/tags/tag-id"},
		{[]string{"create-tag", `{}`}, http.MethodPost, "/v1/tags"},
		{[]string{"update-tag", "tag-id", `{}`}, http.MethodPut, "/v1/tags/tag-id"},
		...
		{[]string{"networks"}, http.MethodGet, "/v1/networks"},

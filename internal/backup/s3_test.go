...
func TestS3ConfigurationAndObjectKey(t *testing.T) {
	...
	for _, config := range []S3Config{
		...
		{Endpoint: "https://objects.example.test", Bucket: "ab", UseTLS: true, AccessKey: "a", SecretKey: "s"},
		{Endpoint: "https://objects.example.test", Bucket: strings.Repeat("b", maxS3BucketBytes+1), UseTLS: true, AccessKey: "a", SecretKey: "s"},
		{Endpoint: "https://objects.example.test", Bucket: "backup/object", UseTLS: true, AccessKey: "a", SecretKey: "s"},
		{Endpoint: "https://objects.example.test", Bucket: "backup..object", UseTLS: true, AccessKey: "a", SecretKey: "s"},
		{Endpoint: "https://objects.example.test", Bucket: "127.0.0.1", UseTLS: true, AccessKey: "a", SecretKey: "s"},
		{Endpoint: "https://objects.example.test", Bucket: "bäckups", UseTLS: true, AccessKey: "a", SecretKey: "s"},

...
func TestDatabaseMetricsQueriesRemainValid(t *testing.T) {
	...
	for _, expected := range []string{
		...
		`dockyard_volume_restore_last_failure_age_seconds{mode="offline"}`,

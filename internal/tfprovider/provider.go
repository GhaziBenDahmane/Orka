...
func (p *dockyardProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{newProjectResource, newProjectTagsResource, newEnvironmentResource, newServiceResource, newRouteResource, newTagResource, newServiceTagsResource, newNetworkResource, newServiceNetworksResource, newDatabaseResource, newLinkedDatabaseResource, newSourceCredentialResource, newCustomTLSCertificateResource, newBackupDestinationResource, newBackupPolicyResource, newVolumeBackupPolicyResource, newTemplateRepositoryResource, newOIDCProviderResource, newSAMLProviderResource, newSCIMTokenResource, newServiceAccountResource, newDeployTokenResource, newInvitationResource, newAccessGrantResource, newResourcePolicyResource, newClusterResource, newNotificationEndpointResource, newAuditRetentionResource, newAuditArchiveResource, newAuthSettingsResource}
}
